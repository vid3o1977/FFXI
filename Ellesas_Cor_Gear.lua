...
function init_gear_sets()
    ...
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'MND+2','Accuracy+17','Weapon skill damage +7%','Accuracy+17 Attack+17',}},
    feet={ name="Herculean Boots", augments={'Attack+15','Weapon skill damage +3%','DEX+10',}},
    neck="Fotia Gorget",
	...
	-- Weapons sets
	sets.weapons.Default = {main="Naegling",sub="Demersal dagen +1",range="Fomalhaut"}
	sets.weapons.DualWeapons = {main="Naegling",sub="Demersal dagen +1",range="Fomalhaut"}
	sets.weapons.DualSavageWeapons = {main="Naegling",sub="Demersal dagen +1",range="Ataktos"}
	sets.weapons.DualLeadenRanged = {main="Naegling",sub="Demersal dagen +1",range="Fomalhaut"}
	...
	sets.weapons.DualKustawi = {main="Naegling",sub="Kustawi",range="Fomalhaut"}
