...
function user_setup()
	...
	send_command('@wait 5;input /lockstyleset 015')
...
function init_gear_sets()
	...
	weaponlock_main="Aeneas" ---Carnwenhan ---Twashtar
	weaponlock_sub="Twashtar" ---Qutrub Knife ---Aeneas
	    -- Precast Sets
    ...
    sets.precast.FC["Honor March"] = set_combine(sets.precast.FastCast.BardSong,{range="Marsyas"})    
    ...
    sets.precast.WS = {
    range={ name="Linos", augments={'Accuracy+14','Weapon skill damage +3%','DEX+6',}},
	...
	range={ name="Linos", augments={'Accuracy+14','"Dbl.Atk."+3','Quadruple Attack +2',}},
    ...
    sets.midcast.Lullaby = {hands="Brioso Cuffs +3",range="blurred harp +1"}
    sets.midcast.Madrigal = {head="Fili Calot +1",back={ name="Intarabus's Cape", augments={'CHR+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}}}
    ...
    sets.midcast.Minne = {legs="Mousai seraweels"}
 	sets.midcast.Dirge = {hands="Bihu Cuffs"} 
    sets.midcast.Paeon = {head="Brioso Roundlet +3"}
    sets.midcast.Carol = {hands="Mousai Gages"}
    sets.midcast["Sentinel's Scherzo"] = {feet="Fili Cothurnes +1"}
    sets.midcast['Magic Finale'] = {neck="",waist="Luminary Sash",legs=""}
    ...
    sets.midcast.SongRecast = {ear2="Loquacious Earring",ring1="",legs="Fili Rhingrave +1"} --back="Harmony Cape",waist="Corvax Sash",
    ...
    right_ring="Defending Ring",
    back={ name="Intarabus's Cape", augments={'MND+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity-10','Mag. Evasion+15',}},
	}
    ...
    neck="Mnbw. Whistle +1",---Bard's Charm +1 Mnbw. Whistle +1
    waist="Luminary Sash",
    left_ear="Regal Earring",
	...
	main="Sangoma",
    sub="Genmei Shield",
    range={ name="Linos", augments={'Mag. Evasion+15','Phys. dmg. taken -4%','MP+20',}},
    head="Aya. Zucchetto +2",
    body="Inyanga Jubbah +2",
    hands="Inyan. Dastanas +2",
    legs="Inyanga Shalwar +2",
    ...
    hands={ name="Chironic Gloves", augments={'Phys. dmg. taken -1%','"Fast Cast"+2','Quadruple Attack +2','Accuracy+18 Attack+18',}},
    legs="Aya. Cosciales +2",
    ...
    --sets.obi.Wind = {waist=''}
    --sets.obi.Ice = {waist=''}
    --sets.obi.Lightning = {waist=''}
    --sets.obi.Light = {waist=''}
    --sets.obi.Dark = {waist=''}
    --sets.obi.Water = {waist=''}
    --sets.obi.Earth = {waist=''}
    --sets.obi.Fire = {waist=''}
...
function calculate_duration(spell, spellMap)
	...
	if player.equipment.neck == "Moonbow Whistle +1 +1" then mult = mult + 0.2 end 
    if player.equipment.body == "Fili Hongreline +1" then mult = mult + 0.12 end
    if player.equipment.legs == "Inyanga Shalwar +2 +1" then mult = mult + 0.15 end
	if player.equipment.legs == "Inyanga Shalwar +2 +1" then mult = mult + 0.17 end
	...
	if buffactive.Troubadour then 
		totalDuration = totalDuration + 20  -- Assuming 20 seconds for capped Trobodour and you actually pre-cast with a Bihu Justaucorps +1 +1 +1.
	end
